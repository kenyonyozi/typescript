...
// class
// var JumiaCustomer = /** @class */ (function () {
//     function JumiaCustomer(nameArg, addressArg) {
//         this.name = nameArg;
//         this.address = addressArg;
//     }
//     ;
//     return JumiaCustomer;
// }());
// KEY WORD NEW AND THIS
// var customer1 = new JumiaCustomer('john', 'newyork');
// var customer2 = new JumiaCustomer('jen', 'la');
// var customer3 = new JumiaCustomer('jake', 'boston');
// customer1.name = 'bob'; //to change the name or
// customer1['name'] = 'bob'; //better way to change namecause you can add first name or last name
// console.log(customer1.name);
